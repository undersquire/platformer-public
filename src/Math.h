...
struct Rectangle
{
    ...
    bool Intersects(const Vector2<float> &, const Vector2<float> &, Vector2<float> &, Vector2<float> &,
                    float &) const noexcept;
    bool Intersects(const Rectangle &, const Vector2<float> &, const float, Vector2<float> &, Vector2<float> &,
                    float &) const noexcept;
    bool Intersects(const Vector2<float> &, const Rectangle &, const Vector2<float> &, const float, Vector2<float> &,
