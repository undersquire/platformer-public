...
Skeleton::Skeleton(Backend *backend, Vector2<float> &spawn) noexcept : Entity(backend, EntityType::Skeleton)
{
...
bool Skeleton::OnCollide(int i, Tile &tile, const Vector2<float> &contact, const Rectangle &tile_pos) noexcept
{
