...
bool Rectangle::Intersects(const Vector2<float> &origin,
                           const Vector2<float> &direction,
                           Vector2<float> &contact_point,
                           Vector2<float> &contact_normal,
                           float &hit_near) const noexcept {
  contact_normal = {0, 0};
  contact_point = {0, 0};
...
bool Rectangle::Intersects(const Rectangle &other,
                           ...
                           const float deltaTime, Vector2<float> &contact_point,
                           Vector2<float> &contact_normal,
  ...
  if (expanded.Intersects(other.pos + other.size / 2, velocity * deltaTime,
...
bool Rectangle::Intersects(const Vector2<float> &dyn_velocity,
  ...
  if (expanded.Intersects(other.pos + other.size / 2,
                          (velocity - dyn_velocity) * deltaTime, contact_point,
